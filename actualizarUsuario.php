                  ...
                  $Accion = $_GET['Accion'];
									...
									elseif ($Accion == 7)
									{
										echo '<div class="alert alert-warning" role="alert">
											  <strong>Warning!</strong> La contraseña actual es incorrecta.
											</div>				<a href="ModificarPerfil.php?Accion=3">	<input type="button" name="" value="Regresar"></a>';
									}
									elseif ($Accion == 6)
									 {
                        ...
                        <form method="post" action="ModificarPerfil-set.php">
                          <div class="row 100%">
                            <div class="12u 12u(mobile)">
                              ...
                              <input name="OldUsername" value="'.$UsuarioCambio.'" type="text" readonly />
															<input name="Nivel" value="'.$Nivel.'" type="text" style="Display:none;" />
															<input name="UsrOriginal" value="'.$nombre.'" type="text" style="Display:none;" />
